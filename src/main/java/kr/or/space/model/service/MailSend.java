...
public class MailSend {
	public String mailSend(String email)  {
		...
		try {
			...
			// 이메일 제목설정
			msg.setSubject("[Musée d'art] 대관신청 안내드립니다 ", "UTF-8");
			// 이메일 내용설정
			msg.setContent("<h1>Musée d'art입니다.</h1>"+"<h3>대관 신청이 완료되었습니다. 사용에 관한 자세한 사항은 홈페이지를 참고해주세요.</h3>", "text/html;charset=UTF-8");
			// 이메일 전송
			Transport.send(msg);
			result = true;
