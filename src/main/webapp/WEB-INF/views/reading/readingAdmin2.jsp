...
<body>
	...
	<link href="resources/readingCss/readingAdmin2.css" rel="stylesheet">
	...
	<script type="text/javascript" src="/resources/jquery-ui/jquery-ui.min.js"></script>
		<div class="container">
			...
			<ul id="titlemenu" class="nav nav-pills nav-justified">
				<li class="active"><a data-toggle="pill" href="#week">최근 1주일 예약 & 퇴실조치</a></li>
				<li><a data-toggle="pill" href="#period">전체 예약 내역</a></li>
				<li><a data-toggle="pill" href="#black">블랙리스트</a></li>
				<li><a data-toggle="pill" href="#fixtures">비품대여내역</a></li>
			</ul>
			...
			<div class="tab-content">
		 		...
		 		<div id="black" class="tab-pane fade">
		 			<br><br>
